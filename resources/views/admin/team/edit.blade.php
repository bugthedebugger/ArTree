        ...
        <form action="{{ route('admin-team-store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{ $member->name }}" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="e.g. Clark Kent" required>
                        @error('name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{ $member->number }}" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" placeholder="e.g. +977 1234567890" required>
                        @error('phone')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{ $member->email }}" class="form-control @error('email') is-invalid @enderror" name="email" id="email" placeholder="e.g. artreenepal@gmail.com" required>
                        @error('email')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
